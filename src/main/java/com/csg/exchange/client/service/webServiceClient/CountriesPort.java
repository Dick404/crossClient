...
public interface CountriesPort {
    ...
    public PushAlertInfoResponse pushAlertInfo(
        @WebParam(name = "pushAlertInfoRequest", targetNamespace = "http://spring.io/guides/gs-producing-web-service", partName = "pushAlertInfoRequest")
        PushAlertInfoRequest pushAlertInfoRequest);
